package cn.mrain.sso_server.auto_Authorization_to_jump;
...
/**
 * @author 22
 * security oauth2 默认有一个确认授权的页面用WhitelabelApprovalEndpoint，在自己的应用中可以直接忽略这个页面
 * 我们可以重写这个页面，用@RestController标注，覆盖它的@FrameworkEndpoint标注。
 */
@RestController
...
public class MyWhitelabelApprovalEndpoint {
    ...
    protected String createTemplate(Map<String, Object> model, HttpServletRequest request) {
        ...
        //在body标签中添加style='display:none;' 让body不显示
